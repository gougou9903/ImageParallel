...
public class smoothing extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        BufferedImage smoothingPart;
        
        if(e.getSource() == btnProcess){
            try{
                smoothingPart = final_img.getSubimage(captureRect.x, captureRect.y, captureRect.width, captureRect.height);
                lblPicture.setIcon(new ImageIcon(smoothingPart));
